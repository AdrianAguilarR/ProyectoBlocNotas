<?php 
    ...
    echo "<h1> Todas Las Tareas Vencidas de $nombre </h1>" ;
    echo " Menú de tareas: ";
    ...
    $query = "SELECT * FROM tarea WHERE usuario = '$username' and categoria='vencido'";
    $result = $conexion->query($query);
    ...
    for ($j = 0; $j < $rows; $j++)
    {
        ...
        <form action='Tarea_vencida.php' method='post'>
